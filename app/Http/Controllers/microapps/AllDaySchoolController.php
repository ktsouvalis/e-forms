        ...
        if($microapp->accepts){
            ...
            if($request->file('table_file')){
                ...
                while ($rowSumValue != "" && $row<400){
                    ...
                    else if($time=='16:00' or $time=='4:00:00 μμ' or abs($time-0.66666666666667< 0.00001) or $time=='16:00 ή 15:50' or $time=='16:00:00') {
                        $nos4++;
                    }
                    else if($time=='17:30' or $time=='5:30:00 μμ' or abs($time-0.72916666666667< 0.00001) or $time=='17:30:00'){
                        $nos5++;
                    }
