...
function addField() {
    ...
    let lastElementNumber = parseInt(lastElementId.replace('choices', ''));  
    numberOfElements = lastElementNumber + 1;
    ...
    $('#fields').append($("<div class='input-group' id='" + newDivId + "'></div>")).after(lastElement);
