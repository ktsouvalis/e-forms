            ...
            var warning = `
                <div class="col-12 mt-1">
                    <div class="alert alert-danger mb-0 py-2">
                        ...
                        Προσοχή:<strong> Πιθανώς </strong>λάθος τύπος άδειας!
                        Οι <strong>${leave.leave_days} ημέρες</strong> υπερβαίνουν το όριο των ${HOSP_DAY_THRESHOLD} ημερών αναρρωτικής. <br>
                        Ο σωστός τύπος πιθανότατα είναι: <em>Γνωμάτευση Α/βάθμιας Υγειονομικής Επιτροπής</em> εκτός αν πρόκειται για χειρουργείο σε Νοσοκομείο.<br>
                        Επικοινωνήστε με το γραφείο Αδειών.
                    </div>
                </div>`;
