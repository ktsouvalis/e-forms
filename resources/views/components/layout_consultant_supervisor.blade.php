  ...
  <body>
   ...
   <div class="justify-content-auto" style="background-color: #fffde3;"> 
      ...
      <div class="row justify-content-md-center">
        <div class="col">
          <div class="hstack justify-content-start gap-2">
            ...
            @endif
              <div class=" d-flex px-2"><a href='{{url('/index_consultant')}}' class="text-dark" style="text-decoration:none; " data-toggle="tooltip" title="Αρχική">{{$user->name}} {{$user->surname}} (ως Επόπτης)</a></div>
    ...
    @push('app-icon')
      ...
      <div class="d-flex justify-content-center h4">{{$user->name}} {{$user->surname}} (ως Επόπτης)</div>
    @endpush
