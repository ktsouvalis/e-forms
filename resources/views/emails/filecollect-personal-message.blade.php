...
Σας ενημερώνουμε ότι μέσω της εφαρμογής <strong>Ηλεκτρονικές Φόρμες</strong> της Διεύθυνσης Π.Ε. Αχαΐας, μπορείτε να δείτε ένα <b>νέο μήνυμα<b> που σας έχει αποσταλλεί στην ενότητα <b>{{$stakeholder->filecollect->name}}</b>.
<br><br>
