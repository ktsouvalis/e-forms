...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge" />
        ...
        <link rel="stylesheet" href="http://localhost:8000/bootstrap/css/bootstrap.css" rel="stylesheet"/>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.0/font/bootstrap-icons.css">
    <link rel="icon" href="http://localhost:8000/favicon/favicon.ico"/>
    ...
    <link rel="mask-icon" href="http://localhost:8000/favicon/safari-pinned-tab.svg" color="#5bbad5">
...
<div class="row">
    ...
    <div class="col-2 d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary d-none d-md-block " style="width: 280px; opacity:0.2;">
        <div class="d-flex justify-content-center"><img src="http://localhost:8000/favicon/android-chrome-512x512.png" width="100" height="100" alt="services"></div>
    ...
    <div class="col-8">
        <div class="container ">
            ...
            <div class="row flex justify-content-end">
                ...
                <div class="col px-4 pb-3"> <a href="{{url('/index_user')}}" class="position-absolute top-0 end-0 text-secondary"><i class="fa fa-sign-in" aria-hidden="true"> Σύνδεση Υπαλλήλου Διεύθυνσης</i></a>
                </div>
        </div>
    </div>
...
<div class="row justify-content-md-center m-2">
    <div class="col p-5 my-2 me-2 bg-success border border-danger shadow rounded text-white">
        Για τεχνικά θέματα αποστολή mail στο Τμήμα Πληροφορικής & Νέων Τεχνολογιών της ΔΙΠΕ Αχαΐας: it@dipe.ach.sch.gr
    </div>
    ...
    <div class="col p-5 my-2 ms-2 bg-warning border border-danger shadow rounded text-dark">
        Δεν επιτρέπεται πρόσβαση στις Ηλεκτρονικές Φόρμες για μη εξουσιοδοτημένους χρήστες.
    </div>
...
@endif 
    ...
    <script src="http://localhost:8000/bootstrap/js/bootstrap.js"></script>
    <script
