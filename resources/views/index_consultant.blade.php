            ...
            <div class="py-5">
                <div class="container">
                    <div class="row hidden-md-up justify-content-center">
                        ...
                        <div class="col-md-4 py-2" style="max-width:15rem">
                            <div class="card py-5" style="background-color:Khaki; text-align:center;">
                                <a  class="text-dark" style="text-decoration:none;" href="{{url("/consultant_evaluation")}}">
                                <div class="h5 card-title fa-solid fa-star"></div>
                                <div>Αξιολόγηση-Β</div>
                                </a> 
                            </div>
                        </div> 
                        <hr>
