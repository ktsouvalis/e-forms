<x-layout_consultant_supervisor>
    <body class="bg-light">
    ...
    <div class="row hidden-md-up justify-content-center">
        @auth('consultant')
            ...
            @push('title')
                <title>Επόπτης Ποιότητας Εκπαίδευσης</title>
            @endpush
            ...
            <div class="py-5">
                <div class="container">
                    <div class="row hidden-md-up justify-content-center">
                        <h3>Επόπτης Ποιότητας Εκπαίδευσης</h3>
                        ...
                        <div class="col-md-4 py-2" style="max-width:15rem">
                            <div class="card py-5" style="background-color:skyblue; text-align:center;">
                                <a  class="text-dark" style="text-decoration:none;" href="{{url("/consultant_teachers")}}">
                                <div class="h5 card-title fa-solid fa-signature"></div>
                                <div>Εκπαιδευτικοί</div>
                                </a> 
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="col-md-4 py-2" style="max-width:15rem">
                            <div class="card py-5" style="background-color:#ff8f00; text-align:center;">
                                ...
                                <a  class="text-dark" style="text-decoration:none;" href="{{route("work_planning.index")}}">
                                <div class="h5 card-title fa-solid fa-map"></div>
                                <div>Προγραμματισμός Έργου Συμβούλων Εκπαίδευσης</div>
                                </a> 
                            </div>
                        </div> 
                        <hr>
                        ...
                        <div class="col-md-4 py-2" style="max-width:15rem">
                            <div class="card py-5" style="background-color:#ffd044; text-align:center;">
                                <a  class="text-dark" style="text-decoration:none;" href="{{url("/index_consultant")}}">
                                <div class="h5 card-title fa-solid fa-layer-group"></div>
                                <div>Σύνδεση ως Σύμβουλος Εκπαίδευσης </div>
                                </a> 
                            </div>
                        </div>
                        @endif
