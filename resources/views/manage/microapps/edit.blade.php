<x-layout>
    ...
    <div class="container">
        ...
        <div class="vstack gap-2 py-3">
            ...
            <div class="hstack gap-2">
                <a href="{{url("/preview_mail_all_whocans/microapp/$microapp->id")}}" class="btn btn-outline-secondary bi bi-binoculars no-spinner" target="_blank"> Προεπισκόπηση email</a>
