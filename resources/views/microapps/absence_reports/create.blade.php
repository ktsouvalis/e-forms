                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3">
                            ...
                            <strong>Παρακαλούμε να γίνεται υποβολή ακόμα και αν δεν υπάρχουν απουσίες με τιμή 0 για να διασφαλιστεί η ακρίβεια των δεδομένων.</strong>
                        </li>
                        <li class="mb-3">
                            <i class="bi bi-check-circle text-success me-2"></i>
                        ...
                        <li class="mb-3">
                            <i class="bi bi-check-circle text-success me-2"></i>
                            Μετά την προθεσμία, δεν είναι δυνατή η τροποποίηση ή η υποβολή νέας αναφοράς για την ίδια ημέρα καθώς τα στοιχεία αποστέλλονται άμεσα στο Υ.ΠΑΙ.Θ.Α. μέσω της Περιφ/κής Δ/νσης Π.Ε. & Δ.Ε. Δυτ. Ελλάδας
                        </li>
