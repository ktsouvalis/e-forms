        ...
        <div class="col-12 col-md-10 col-lg-8 mx-auto">
            <div class="card border-primary rounded-3 shadow-sm">
                <div class="card-header bg-info text-white text-center py-3">
                    ...
                    <p class="mb-0">
                        Υποβάλλονται όλα τα αρχεία που υποβάλλονται προς τον οικείο Δήμο με τη λήξη του σχολικού έτους και κοινοποιούνται στη Διεύθυνση Π.Ε. Αχαΐας. 
                        <br> Μπορείτε να υποβάλλετε τυχόν παρατηρήσεις και μια συνολική αξιολόγηση της σοβαρότητας της συνολικής κατάστασης.
                    </p>
                </div>
