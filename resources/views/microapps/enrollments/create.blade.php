    ...
    <div class="container px-5">
        ...
        <div class="alert text-center">
            ...
            @if($school->primary == 1) 
                ...
                2) Υποβάλλετε τον <strong>αριθμό μαθητών κατά τμήμα</strong> μαζί με τυχόν παρατηρήσεις <br>για κάθε τμήμα (π.χ. διχοτόμηση, εκκρεμείς μετεγγραφές, κλπ). <br>
                3) Υποβάλλετε το αρχείο για τη λειτουργία του Ολοήμερου συμπληρώνοντας <strong> και τα δύο Φύλλα του αρχείου excel.</strong>
            @else
                1) Υποβάλλετε τον <strong>αριθμό μαθητών κατά τμήμα </strong>μαζί με τυχόν παρατηρήσεις για κάθε τμήμα (π.χ. εκκρεμείς μετεγγραφές, κλπ). <br>Η ονομασία των τμημάτων (Τμήμα 1, κλπ είναι ενδεικτική) <br>
                2) Υποβάλλετε τα στοιχεία για τη λειτουργία του <strong>Ολοήμερου Προγράμματος και Πρωινής Υποδοχής </strong>συμπληρώνοντας τα κατάλληλα πεδία.
            @endif
        </div>
        @endif
