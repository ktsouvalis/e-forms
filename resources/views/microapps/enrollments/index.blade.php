        ...
        <nav class="container navbar navbar-light bg-light">
            ...
            <div class="row">
                ...
                <div class="col hstack gap-3">
                    <form action="{{url("microapps/enrollments/upload_file/3_enrollments_extra_section_dim.docx")}}" method="post" enctype="multipart/form-data" class="container-fluid">
                        @csrf
                        <div class="input-group">
                            {{-- <span class="input-group-text w-25"></span> --}}
                ...
                <div class="col hstack gap-3">
                    <form action="{{url("microapps/enrollments/upload_file/3_enrollments_extra_section_nip.docx")}}" method="post" enctype="multipart/form-data" class="container-fluid">
                        @csrf
                        <div class="input-group">
                            {{-- <span class="input-group-text w-25"></span> --}}
