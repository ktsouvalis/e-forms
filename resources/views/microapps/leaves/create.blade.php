                ...
                <div>
                    ...
                    <div class="collapse" id="instructionsList">
                        ...
                        <ul class="list-group m-3">
                            <li class="list-group-item">1) Καταχώρηση άδειας στο mySchool από τη Σχολική Μονάδα. 
                            </li>
                            ...
                            <li class="list-group-item">5) Με την τελική έγκριση της άδειας (όπου απαιτείται) από τη Διεύθυνση Π.Ε. Αχαΐας, η Σχολική Μονάδα ενημερώνεται αυτόματα μέσω email.
                            </li>
