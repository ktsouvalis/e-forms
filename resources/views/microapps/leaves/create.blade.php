...
<div class="container my-4">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingProcess">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseProcess" aria-expanded="false" aria-controls="collapseProcess">
                    ...
                    <span class="accordion-hint ms-auto me-2 small fw-normal opacity-75">
                        <i class="bi bi-hand-index me-1"></i>Κλικ για ανάπτυξη
                    </span>
                    <i class="bi bi-chevron-down accordion-chevron ms-1"></i>
                </button>
            </h2>
                            ...
                            <div class="card h-100 border-warning">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text small text-muted">
                                        ...
                                        Στην περίπτωση αυτή, αφού διορθώσετε τα αρχεία, πρέπει να την επανυποβάλετε στη Διεύθυνση ώστε να ενημερωθεί το πρωτόκολλο.<br>
                                        <strong>ΠΡΟΣΟΧΗ!</strong> Στην περίπτωση που μια πρωτοκολλημένη άδεια ανακαλείται στο mySchool και επανυποβάλλεται,
                                        οι Ηλεκτρονικές Φόρμες την εντοπίζουν και <strong>ενημερώνουν αυτόματα το πρωτόκολλο</strong> (από 11/02/2026). Δεν απαιτείται καμία ενέργεια από τη Σχολική Μονάδα.
                                    </p>
                                    <ul class="list-unstyled text-start small">
                                        <li class="mb-2">
    ...
    {{-- Ξεχωριστό στυλ ώστε να μην μοιάζει με ανοιχτό accordion ή μήνυμα συστήματος --}}
...
/* Κρύβουμε το default Bootstrap βέλος και χρησιμοποιούμε το δικό μας */
.accordion-button::after {
    display: none;
}

/* Βέλος που περιστρέφεται όταν ανοίγει */
.accordion-chevron {
...
/* Hint κρύβεται όταν είναι ανοιχτό */
.accordion-button:not(.collapsed) .accordion-hint {
    display: none;
}
