        ...
        <div class="py-3">
            <div class="container">
                <div class="instruction-container p-4 border rounded shadow-sm bg-light">
                    ...
                    <p class="text-dark lh-base">
                        * Η λειτουργικότητα είναι σε Δοκιμαστική Λειτουργία. Τα στοιχεία που θα καταχωρηθούν θα καταχωρηθούν κανονικά. Ενδέχεται να προκύψουν σφάλματα κατά τη διαδικασία καταχώρησης για τα οποία παρακαλούμε να επικοινωνείτε με το Τμήμα Πληροφορικής στo it@dipe.ach.sch.gr ή στο 2610229262.
                    </p>
                </div>
