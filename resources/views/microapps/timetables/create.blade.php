        ...
        <div class="collapse" id="instructionsList">    
            <ul class="list-group m-3">
                ...
                <li class="list-group-item">3) <strong>Έγκριση εντύπων Ωρολογίου Προγράμματος από τη Διεύθυνση.</strong>
                    ...
                    <br>Όταν σφραγιστούν και υπογραφούν θα ειδοποιηθεί το Σχολείο να παραλάβει το εγκεκριμένο πρόγραμμα με σφραγίδα και υπογραφή σε δύο αντίγραφα (Το ένα μένει στη Διεύθυνση).
                </li>  
            </ul>
        </div>
    </div>
