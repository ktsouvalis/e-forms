        ...
        <div class="collapse" id="instructionsList">    
            <ul class="list-group m-3">
                <li class="list-group-item">1) <strong>Αρχική Υποβολή Εντύπων Ωρολογίου Προγράμματος από το Σχολείο </strong>
                    <br>
                    <br>Το Σχολείο υποβάλλει όλα τα σχετικά έντυπα του Ωρολογίου Προγράμματος. Τα έντυπα αναμένουν έγκριση ή αίτημα για διόρθωση από τη Διεύθυνση
                    <br>Τα έτυπα σε αυτή τη φάση μπορούν να διαγραφούν και να υποβληθούν νέα από τη Σχολική Μονάδα</li>
                <li class="list-group-item">2) <strong>Ο αρμόδιος υπάλληλος της Διεύθυνσης ελέγχει τα έντυπα και αν εντοπιστούν λάθη επικοινωνεί με το Σχολείο για υποβολή διορθώσεων.</strong>
                    <br>
                ...
                <li class="list-group-item">3) <strong>Έγκριση εντύπων Ωρολογίου Προγράμματος από τη Διεύθυνση.</strong>
                    <br>
                    <br>Όταν ολοκληρωθεί ο έλεγχος των εντύπων, η Διεύθυνση εγκρίνει τα έντυπα και το πρόγραμμα κλειδώνει. Τα εγκεκριμένα προγράμματα εμφανίζονται σε άλλη ενότητα.
                    <br>Στην ενότητα "Έντυπα" μπορεί να υποβληθεί νέο πρόγραμμα από τη Σχολική Μονάδα.
                    <br>Το Σχολείο προσκομίζει τα έντυπα σφραγισμένα και υπογεγραμμένα σε τρία αντίγραφα στο Πρωτόκολλο της Διεύθυνσης και παραλαμβάνει το εγκεκριμένο πρόγραμμα με σφραγίδα και υπογραφή.
                </li>  
            </ul>
        </div>
    </div>
